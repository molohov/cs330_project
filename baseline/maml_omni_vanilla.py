...
from maml_omni_vanilla2 import MAML
...
def main(_):
    ...
    exp_name = '%s.beta-%g.meta_lr-%g.update_lr-%g.trial-%d' % (
      'maml_omni_vanilla', FLAGS.beta, FLAGS.meta_lr, FLAGS.update_lr, FLAGS.trial)
    ...
    inputa_val, labela_val, inputb_val, labelb_val = ds_val.make_one_shot_iterator().get_next()
